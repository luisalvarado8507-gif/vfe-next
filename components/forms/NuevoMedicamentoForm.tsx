...
const FF_OPTIONS = [
  { group: 'Sólidos orales', items: [['comprimido','Comprimido'],['comprimido recubierto con película','Comprimido recubierto con película'],['comprimido de liberación prolongada','Comprimido de liberación prolongada'],['comprimido masticable','Comprimido masticable'],['comprimido sublingual','Comprimido sublingual']] },
  { group: 'Cápsulas', items: [['cápsula dura','Cápsula dura'],['cápsula blanda','Cápsula blanda'],['cápsula gastrorresistente','Cápsula gastrorresistente'],['cápsula de liberación prolongada','Cápsula de liberación prolongada']] },
  { group: 'Líquidos orales', items: [['solución oral','Solución oral'],['suspensión oral','Suspensión oral'],['jarabe','Jarabe'],['gotas orales, solución','Gotas orales, solución'],['granulado para solución oral','Granulado para solución oral'],['polvo para suspensión oral','Polvo para suspensión oral']] },
  { group: 'Parenterales', items: [['solución inyectable','Solución inyectable'],['polvo para solución inyectable','Polvo para solución inyectable'],['suspensión inyectable','Suspensión inyectable'],['solución para perfusión','Solución para perfusión IV']] },
  { group: 'Inhalados', items: [['solución para inhalación en envase a presión','Inhalador presurizado'],['polvo para inhalación','Polvo para inhalación'],['solución para nebulización','Solución para nebulización']] },
  { group: 'Tópicos', items: [['crema','Crema'],['pomada','Pomada'],['gel','Gel'],['loción','Loción'],['parche transdérmico','Parche transdérmico']] },
  { group: 'Oftálmicos / Óticos / Nasales', items: [['colirio en solución','Colirio, solución'],['colirio en suspensión','Colirio, suspensión'],['gotas óticas, solución','Gotas óticas, solución'],['spray nasal, solución','Spray nasal, solución']] },
  { group: 'Rectales / Vaginales', items: [['supositorio','Supositorio'],['óvulo vaginal','Óvulo vaginal'],['crema vaginal','Crema vaginal']] },
];
